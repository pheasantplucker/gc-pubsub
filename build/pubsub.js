...
const publishJson = (() => {
  var _ref10 = _asyncToGenerator(function* (topicName, message) {
    const { data: messageData } = message;
  ...
  return function publishJson(_x10, _x11) {
    return _ref10.apply(this, arguments);
  };
})();

const publishMany = (() => {
  var _ref11 = _asyncToGenerator(function* (topicName, messages) {
    const promises = map(function (m) {
      return publish(topicName, m);
    }, messages);
  ...
  return function publishMany(_x12, _x13) {
    return _ref11.apply(this, arguments);
  };
})();

const publishManyJson = (() => {
  var _ref12 = _asyncToGenerator(function* (topicName, messages) {
    const updatedMessages = map(function (m) {
      return Object.assign({}, m, { data: JSON.stringify(m.data) });
    }, messages);
    return publishMany(topicName, updatedMessages);
  });

  return function publishManyJson(_x14, _x15) {
